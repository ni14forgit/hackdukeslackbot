  ...
  bot.getUsers().then(function(answer) {
    ...
    switch (jsondata.intent[0].value) {
      ...
      case "submit":
        ...
        break;
      case "schedule":
        sendFile("HDSchedule.pdf", "Here's our schedule!", channelid);
        break;
      case "finding_team":
      ...
      case "introduction":
        pretext = "";
        text =
          "Hi! I'm KitKat! I'm here to answer questions you may have! (Meals/snacks, submissions, sponsors, coding help, schedule, and more!)";
        sendMessage(pretext, text, color, channelid);
        break;
      default:
        pretext = "So sorry...";
